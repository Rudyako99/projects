document.addEventListener("DOMContentLoaded", function() {
	...
	s.scope = {}, s.findInternal = function(t, a, e) {
		...
		}, s.ASSUME_ES5 = !1, s.ASSUME_NO_NATIVE_MAP = !1, s.ASSUME_NO_NATIVE_SET = !1, s.SIMPLE_FROUND_POLYFILL = !1,
		s.defineProperty = s.ASSUME_ES5 || "function" == typeof
	Object.defineProperties ? Object.defineProperty : function(t, a, e) {
	...
	t = jQuery, a = {
		...
		showProducts: function(s) {
			let r = t("<form>").attr({
				...
				}).html("Ціна за 1 товар або послугу").append(p),
				u = t("<div>").attr({
		...
		commonResult: function(e, s, r) {
			let n = 0,
				...
				}).text("Кошик порожній. Ви не додали жодного товара").fadeOut(),
				l = t("<div>").attr({
					class: "smart-basket__success-title"
				}).text("Замовлення прийняте. Очікуйте дзвінка").css("display", "none"),
				c = t("<div>").attr({
